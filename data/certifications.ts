...
export const certificationCategories: Category[] = [
  ...
  },
  {
    ...
    description: "شهادات معتمدة في مجال التكنولوجيا والتطوير",
    exams: [
        {
  ...
  },
  {
    id: "microsoft",
    name: "Microsoft",
    description: " شهادات معتمدة عالمياً في ادارة الانظمة, الببيانات وبرامج الاعمال",
    exams: [
        {
            id: "microsoft-word",
            name: "Microsoft Word",
  ...
  },
  {
    id: "intuit",
    name: "Intuit",
    description: "شهادات محاسبة وادارة المالية معتمدة من قبل Intuit",
    exams: [
        {
            id: "quickbooks",
            name: "QuickBooks",
  ...
  },
  {
    id: "pmi",
    name: "PMI",
    description: "شهادات معتمدة في مجال المشاريع والادارة",
    exams: [
        {
            id: "pmi",
  ...
  },
  {
    id: "apple",
    name: "Apple",
    description: "شهادات معتمدة في مجال تطوير تطبيقات الايفون",
    exams: [
        {
