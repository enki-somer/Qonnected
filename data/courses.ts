...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description: "تعلم مفاهيم البرمجة كائنية التوجه وتطبيقها في Python.",
    duration: "8 ساعات",
    level: "intermediate",
    lessons: 28,
    category: "programming",
    image: "/courses/python-oop.jpg",
    instructor: "محمد علي",
    students: 95,
    sections: [
      {
        id: 1,
        title: "مفاهيم OOP الأساسية",
        lessons: [
          {
            id: 1,
  ...
  },
  {
    ...
    description: "بناء تطبيقات سطح المكتب والويب باستخدام Python وأطر العمل الشهيرة.",
    duration: "10 ساعات",
    level: "advanced",
    lessons: 36,
    category: "programming",
    image: "/courses/python-apps.jpg",
    instructor: "عمر خالد",
    students: 72,
    sections: [
      {
